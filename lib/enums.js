...
module.exports = exports = {
  ...
  accountNotifications: new Enum([
    ...
    { id: 'event.accounts.user.verify', name: 'Email Verification' },
    { id: 'event.accounts.user.welcome', name: 'New User Welcome' },
  ...
  orderNotifications: new Enum([
    ...
    { id: 'event.orders.order.adjusted', name: 'Order Adjusted' },
  ...
  salesNotifications: new Enum([
    { id: 'event.sales.lead.ordered', name: 'Lead Placed Order' }
  ]),
