...
module.exports = exports = {
  ...
  eventTopics: new Enum([
    ...
    { id: 'event.orders.order.authorized', name: 'Order Authorized' },
    ...
    { id: 'event.restaurants.restaurant.verify-email', name: 'Restaurant Onboarding Email' },
    { id: 'event.restaurants.restaurant.verify-fax', name: 'Restaurant Onboarding Fax' },
    { id: 'event.restaurants.restaurant.approved', name: 'Restaurant Onboarding Approved' },
    { id: 'event.restaurants.restaurant.rejected', name: 'Restaurant Onboarding Rejected' },
