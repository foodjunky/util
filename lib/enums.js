...
module.exports = exports = {
  ...
  eventTopics: new Enum([
    ...
    { id: 'event.orders.order.deliveryTransmit', name: 'Ready to Transmit (delivery)' },
    { id: 'event.orders.order.batchTransmit', name: 'Ready to Transmit (batch)' },
    { id: 'event.orders.order.confirm', name: 'Ready to Confirm' },
    { id: 'event.orders.order.manualConfirm', name: 'Ready for Manual Confirmation' },
  ...
  orderNotifications: new Enum([
    { id: 'event.orders.notification.started', name: 'Order Started' },
    { id: 'event.orders.notification.submitted', name: 'Order Submitted' },
    { id: 'event.orders.notification.confirmed', name: 'Order Confirmed' },
    { id: 'event.orders.notification.settled', name: 'Order Settled' },
    { id: 'event.orders.notification.enroute', name: 'Order In Transit' },
    { id: 'event.orders.notification.fulfilled', name: 'Order Fulfilled' },
    { id: 'event.orders.notification.canceled', name: 'Order Canceled' },
    { id: 'event.orders.notification.rejected', name: 'Order Rejected' },
    { id: 'event.orders.notification.reminder', name: 'Order Reminder' },
    { id: 'event.orders.notification.declined', name: 'Payment Declined' },
    { id: 'event.orders.notification.survey', name: 'On-Time Survey' },
    { id: 'event.orders.notification.dinerInvite', name: 'Diner Invite' },
    { id: 'event.orders.notification.dinerReminder', name: 'Diner Reminder' },
    { id: 'event.orders.notification.recurringInvite', name: 'Diner Invite (recurring)' },
    { id: 'event.orders.notification.transmit', name: 'Transmit Order (restaurant)' },
    { id: 'event.orders.notification.deliveryTransmit', name: 'Transmit Order (delivery)' },
    { id: 'event.orders.notification.batchTransmit', name: 'Transmit Orders (daily batch)' },
    { id: 'event.orders.notification.batchVerify', name: 'Verify Orders (daily batch)' },
    { id: 'event.orders.notification.confirm', name: 'Confirm Order (auto / ivr)' },
    { id: 'event.orders.notification.manualConfirm', name: 'Confirm Order (manual / ops)' }
  ]),
